...
export default function Sidebar(){
  return(
    ...
    <nav className="flex items-center justify-between px-8 py-4 pb-8 md:flex-col pointer-events-auto md:h-full md:p-6 md:pb-6 md:bg-white md:rounded-3xl md:border md:shadow-sm">
